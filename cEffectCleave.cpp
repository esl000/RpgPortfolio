...
void cEffectCleave::Setup()
{

}

void cEffectCleave::Update()
{
	...
	D3DXVECTOR3 vec = m_pUnit->GetPosition() + 5.0f * m_pUnit->GetDirection();
	vec.y -= 3.0f;
