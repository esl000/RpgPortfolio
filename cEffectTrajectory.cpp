...
void cEffectTrajectory::Setup()
{	
	//검매쉬 통짜로 미리 받는다 쓰는곳에서 그 받은 매쉬로 검의 윗부분 본을 찾는다
	m_pFindMesh = (cSkinnedMesh*)D3DXFrameFind((D3DXFRAME*)m_pOwnerMesh->GetRootFrame(), "Ref_Head");

	m_vPrevPos[0] = D3DXVECTOR3(-1, -1, 0);
	m_vPrevPos[1] = D3DXVECTOR3(0, -4, 0);
...
void cEffectTrajectory::Update()
{
	...
	vCurrentPos[0] = D3DXVECTOR3(-1, -1, 0);
	vCurrentPos[1] = D3DXVECTOR3(0, -4, 0);
